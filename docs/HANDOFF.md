...
**2026-09-17 — UX BẢN ĐỒ + NÚT VỊ TRÍ + HỒ SƠ NGƯỜI CHƠI, ĐÃ DEPLOY** (`web-hjbxaycyl` là bản mới
nhất, trước đó `web-5pdq9ky68` và `web-2dc7ytio3`; alias `chamdiaphuong.io.vn`). Ba việc trong một lần deploy:
