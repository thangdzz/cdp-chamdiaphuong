...
**2026-09-17 — UX BẢN ĐỒ + NÚT VỊ TRÍ + HỒ SƠ NGƯỜI CHƠI, ĐÃ DEPLOY** (`web-r4t28w65n` là bản mới
nhất, trước đó `web-r5eienc8o`, `web-2n1gfngrf`, `web-60u9h7jcj`, `web-2780ec4vo`, `web-q8hmsexiu`, `web-30cq14r6g`, `web-edou16hkn`, `web-9p77ilsve`, `web-9p24dpvva`, `web-hjbxaycyl`, `web-5pdq9ky68`, `web-2dc7ytio3`; alias `chamdiaphuong.io.vn`). Ba việc trong một lần deploy:
