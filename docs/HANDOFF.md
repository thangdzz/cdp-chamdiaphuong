...
**2026-09-17 — UX BẢN ĐỒ + NÚT VỊ TRÍ + HỒ SƠ NGƯỜI CHƠI, ĐÃ DEPLOY** (`web-edou16hkn` là bản mới
nhất, trước đó `web-9p77ilsve`, `web-9p24dpvva`, `web-hjbxaycyl`, `web-5pdq9ky68`, `web-2dc7ytio3`; alias `chamdiaphuong.io.vn`). Ba việc trong một lần deploy:
