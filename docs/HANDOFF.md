...
**2026-09-17 — UX BẢN ĐỒ + NÚT VỊ TRÍ + HỒ SƠ NGƯỜI CHƠI, ĐÃ DEPLOY** (`web-5pdq9ky68` là bản mới
nhất, trước đó `web-2dc7ytio3`; alias `chamdiaphuong.io.vn`). Ba việc trong một lần deploy:
