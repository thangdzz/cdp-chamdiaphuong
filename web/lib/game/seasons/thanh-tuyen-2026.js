...
export const THANH_TUYEN_2026 = {
  ...
  venues: [
    ...
    },
    {
      id: "tuyen-ruoc-den",
      kind: "route",
      // Chủ dự án tả lại ngày 17/9/2026 (bản sửa, thay tuyến tả 16/9): đoàn đi vòng này cả tối.
      name:
        "Tuyến rước đèn — Ngã 8 → Bình Thuận → xuyến Lý Thái Tổ (vòng lại) → Bình Thuận → ngã tư 17/8 " +
        "(quay đầu) → Tân Trào → 17/8 → Phan Thiết → Quang Trung → Ngã 8",
      shortName: "Tuyến rước đèn",
      icon: "🏮",
      // Nét đứt: đây là đường đoàn ĐI QUA rồi lại đi tiếp, khác tuyến phố đi bộ (chỗ đứng xem).
      dashed: true,
      // Bám đúng tim đường theo OpenStreetMap ngày 17/9/2026 (không vẽ tay), vòng khép kín 4.455 m.
      //
      // Tuyến có HAI đoạn đi rồi quay lại, cố ý — đúng như chủ dự án tả:
      //  1. Ngã 8 xuống xuyến Lý Thái Tổ, chạy trọn vòng xuyến rồi ngược lên.
      //  2. Lên hết Bình Thuận tới ngã tư 17/8 (Hội đồng nhân dân tỉnh) thì quay đầu ngay tại đó,
      //     xuống lại Bình Thuận tới xuyến Thành nhà Mạc mới rẽ vào Tân Trào.
      // Bình Thuận và Tân Trào đều là đường đôi một chiều nên hai lượt đi/về nằm ở hai làn khác
      // nhau — nét vẽ không chồng lên nhau.
      //
      ...
      //
      // Mọi bùng binh chạy NGƯỢC kim đồng hồ (xe VN đi bên phải). Cách kiểm nhanh khi dựng lại:
      // diện tích có dấu của vòng, ÂM = ngược kim đồng hồ. Đã đối chiếu: cả 4 way mang tag
      // junction=roundabout quanh đây đều âm, riêng xuyến Ngã 8 (way 1431622682, không có tag đó)
      // dương — tức bị vẽ NGƯỢC trong dữ liệu gốc, dựng tuyến phải theo luật chứ đừng tin chiều vẽ
      // (đã vấp 16/9, và suýt vấp lại 17/9 vì viết ngược dấu).
      source:
        "OSM 17/9/2026: Bình Thuận (309132101, 483014975, 741065202, 741065209, 741065214, 919041157, " +
        "1559810515, 1559810518) · xuyến Ngã 8 1431622682 · xuyến Lý Thái Tổ 741065206 · " +
        "xuyến Thành nhà Mạc 309132108 · Tân Trào chiều TB 896940866 · xuyến Tân Trào/17-8 772332570 · " +
        "17/8 (772332569, 914987540) · Phan Thiết 309132172 · Quang Trung 741065203",
      coordinates: [
        [105.2126495, 21.8151647], [105.2122883, 21.8145376], [105.2113942, 21.8128826],
