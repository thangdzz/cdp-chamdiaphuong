...
- **Thử trên điện thoại qua wifi:** ưu tiên gửi link theo tên máy **`http://MAdz.local:3100`** (Bonjour,
  không đổi khi router cấp IP khác; lấy lại tên bằng `scutil --get LocalHostName`). Địa chỉ LAN của máy Mac đổi theo router (15/9 đổi qua lại
